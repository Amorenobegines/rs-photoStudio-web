const posts = [
    {
        ...
        content: `
      <p>Las sesiones de maternidad permiten capturar la magia de la espera. Lo ideal es planear la sesión entre la semana 28 y 34.</p>
...

    {
        ...
        content: `
      <p>Los recién nacidos son frágiles y necesitan un entorno seguro y cálido. Lo ideal es fotografiar antes de los 15 días.</p>
      <p>Usa mantitas suaves y accesorios como gorritos o pequeños props. Mantén al bebé cómodo y tranquilo.</p>
      <p>Tip: fotos con padres y hermanos quedan muy tiernas y emotivas.</p>
    `,
        date: "2026-03-10",
        tags: ["newborn", "recién nacido", "fotografía"]
    },
...
`,
...

    {
        ...
        content: `
      <p>Las sesiones de verano tienen una magia especial. La luz cálida, los días largos y los colores vibrantes crean el escenario perfecto para fotografías llenas de vida. Es una época que invita a disfrutar, a reír y a dejarse llevar, y eso se refleja en cada imagen.</p>

      <p>Los exteriores se convierten en nuestros mejores aliados: playas, parques, campos de trigo o rincones naturales donde la luz del atardecer envuelve cada gesto con un brillo dorado. La ropa ligera, los tonos suaves y los detalles veraniegos aportan frescura y naturalidad a la sesión.</p>

      <p>Las sesiones de verano son ideales para familias, parejas o niños. Los peques disfrutan jugando, corriendo y explorando, lo que nos permite capturar momentos espontáneos y llenos de alegría. Para los adultos, es una oportunidad de desconectar y vivir una experiencia relajada y bonita.</p>
